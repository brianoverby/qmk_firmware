...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RAISE] = LAYOUT_planck_grid(
        ...
        _______, DK_7,    DK_8,    DK_9,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, _______, _______,
        _______, FN,      KC_LGUI, KC_LALT, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU,  KC_MPLY
    ),
    ...
    [_FN] = LAYOUT_planck_grid(
        ...
        _______, FN,      KC_LGUI, KC_LALT, _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END
    ),
